...
@loop:	lda jorge, x 	; Load the hello message into SPR-RAM one by one, the pointer is increased every time a byte is written. Sprites are referenced by using the third byte of the 4-byte arrays in "hello"
  sta $2004
  inx
  cpx #$50            ;ATTENTION: if you add more letters, you must increase this number by 4 per each additional letter. This is the limit for the sprite memory copy routine
  bne @loop
  rti
...
jorge:
  ...
  .byte $6c, $00, $03, $6c  ; Y=$6c(108), Sprite=00(J), Palette=00, X=%6c(108)
  .byte $6c, $01, $00, $76  ; Y=$6c(108), Sprite=01(O), Palette=00, X=%76(118)
  .byte $6c, $02, $00, $80  ; Y=$6c(108), Sprite=02(R), Palette=00, X=%80(128)
  .byte $6c, $03, $01, $8A  ; Y=$6c(108), Sprite=03(G), Palette=00, X=%8A(138)
  .byte $6c, $04, $01, $94  ; Y=$6c(108), Sprite=04(E), Palette=00, X=%94(148)

  .byte $78, $05, $02, $67  ; Y=$78(120), Sprite=00(T), Palette=00, X=%6c(103)
  .byte $78, $01, $02, $71  ; Y=$78(120), Sprite=01(O), Palette=00, X=%76(113)
  .byte $78, $02, $00, $7B  ; Y=$78(120), Sprite=02(R), Palette=00, X=%80(123)
  .byte $78, $02, $00, $85  ; Y=$78(120), Sprite=02(R), Palette=00, X=%80(133)
  .byte $78, $04, $03, $8F  ; Y=$78(120), Sprite=04(E), Palette=00, X=%94(143)
  .byte $78, $06, $01, $99  ; Y=$78(120), Sprite=04(s), Palette=00, X=%94(153)
